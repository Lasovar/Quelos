...
namespace Quelos {
	...
	public:
		...
		Ref(T* instance)
			: m_Instance(instance)
		{
			static_assert(std::is_base_of<RefCounted, T>::value, "Class does not derive from RefCounted!");
		}
	...
	public:
		...
		bool IsAlive() const { return m_Instance ? RefUtils::IsLive(m_Instance) : false; }
